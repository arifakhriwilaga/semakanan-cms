                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-8 col-sm-8 col-xs-12">
                                ...
                                <div class="form-group">
                                    <a href="javascript:;" style="width: 100%" class="btn btn-primary" @click="saveForm()">Tambah Merchant</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            saveForm () {
                ...
                if (!this.name || !this.image || !this.address || !this.phone || !this.owner || !this.latitude || !this.longitude || !this.open_time || !this.close_time) {
                    this.$notify(
                    {
                        component: {
                    ...
                    axios.post('http://apiadmin.portalsekampus.id/public/api/merchant/create', formData).then(res => {
                        this.$notify({
                            component: {
