        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="title">List Merchant Close List</h4>
                    <p class="category">Menampilkan merchant yang sudah tutup </p>
                </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      getList() {
          axios.get(`http://apiadmin.portalsekampus.id/public/api/merchant/closed`).then(res => {
